    ...
    return (
        <div className="space-y-12 pb-24">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <h1 className="text-5xl font-black text-black tracking-tight uppercase leading-tight">
                ...
                <div className="flex items-center gap-3">
                    <div className="bg-white border border-neutral-100 p-4 rounded-3xl shadow-sm flex flex-col justify-center min-w-[140px]">
                        <span className="text-[10px] font-black text-neutral-400 uppercase tracking-widest mb-1">Global Volume</span>
                        <span className="text-2xl font-black text-black">{(globalStats.totalVolume / 1000).toFixed(1)}k <span className="text-xs text-neutral-400">kg</span></span>
                    </div>
                    <div className="bg-white border border-neutral-100 p-4 rounded-3xl shadow-sm flex flex-col justify-center min-w-[140px]">
                        <span className="text-[10px] font-black text-neutral-400 uppercase tracking-widest mb-1">Global Sessions</span>
                        <span className="text-2xl font-black text-black">{globalStats.totalSessions}</span>
                    </div>
                    <div className="relative group ml-4">
                        ...
                        <input
                            ...
                            className="bg-white border border-neutral-200 pl-11 pr-6 py-3 rounded-2xl text-sm font-bold focus:outline-none focus:ring-2 focus:ring-orange-500/20 w-[240px] transition-all"
                        />
                    </div>
                </div>
            </div>
            ...
            {error || exercises.length === 0 ? (
                <div className="bg-white border border-neutral-200 rounded-[3rem] p-16 text-center max-w-2xl mx-auto shadow-sm">
                    ...
                    <h2 className="text-3xl font-black text-black mb-4 uppercase">No logs detected</h2>
                    ...
                    <AnimatePresence>
                        {filteredExercises.map((ex, idx) => (
                            <motion.div
                                ...
                                className="group bg-white border border-neutral-100 rounded-[2.5rem] p-8 hover:border-orange-500/50 hover:shadow-2xl hover:shadow-orange-500/10 cursor-pointer transition-all duration-500 relative overflow-hidden"
                            >
                                <div className="relative z-10">
                                    ...
                                    <h3 className="text-2xl font-black text-black group-hover:text-orange-600 transition-colors uppercase leading-tight mb-6">
                                        {ex.name}
                                    </h3>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-neutral-50 rounded-2xl p-4 group-hover:bg-white border border-transparent group-hover:border-neutral-100 transition-all">
                                            ...
                                            <p className="text-xl font-black text-black">{ex.bestE1RM}<span className="text-[10px] ml-1">kg</span></p>
                                        </div>
                                        <div className="bg-neutral-50 rounded-2xl p-4 group-hover:bg-white border border-transparent group-hover:border-neutral-100 transition-all">
                                            <p className="text-[9px] font-black text-neutral-400 uppercase tracking-widest mb-1">Volume</p>
                                            <p className="text-xl font-black text-black">{(ex.lifetimeVolume / 1000).toFixed(1)}k<span className="text-[10px] ml-1">kg</span></p>
                                        </div>
                                    </div>

                                    <div className="mt-8 flex items-center justify-between text-neutral-400 group-hover:text-black transition-colors">
